      ...
      if (
        ...
        switch (s.videotype) {
          ...
          case "vimeo":
            ...
            h = (h =
              void 0 != b.player_id
                ? h.replace(b.player_id, m)
                : h + "&player_id=" + m).replace(/&api=0|&api=1/g, "");
            var k = a.is_mobile(),
              x = k || a.isSafari11(),
            ...
            if (
              (e.data("vimeoplayer")
                ? (L = e.data("vimeoplayer"))
                : ((L = new Vimeo.Player(m)), e.data("vimeoplayer", L)),
              x)
            ) {
              var P;
              if (V) P = !0;
    ...
    p = function (e, o, n) {
      ...
      void 0 != w &&
        ...
        void 0 != T &&
          d(T, "click", function () {
            0 == g.muted
              ? ((g.muted = !0), (T.innerHTML = "Unmute"))
              : ((g.muted = !1), (T.innerHTML = "Mute"));
          }),
        void 0 != k &&
          k &&
          d(k, "click", function () {
          ...
          v(e, o),
            h && "audio" != i
              ? ((o.videoplaying = !0),
                ...
                o.c.trigger("revolution.slide.onvideoplay", r(g, "html5", s)))
              : ((o.videoplaying = !1),
